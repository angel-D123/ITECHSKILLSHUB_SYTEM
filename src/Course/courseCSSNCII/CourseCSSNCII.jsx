...
const CourseCSSNCII = () => {
  // Course metadata (will come from database later)
  // Rating will be 0 initially and automatically update when students rate
  const courseMetadata = {
    totalStudents: 0, // Will update when students enroll
    averageRating: 0, // Will update when students submit ratings
    totalRatings: 0,  // Number of ratings submitted
  };
  ...
  const [hasRated, setHasRated] = useState(false); // Track if user already rated
  const [activeTab, setActiveTab] = useState('modules'); // 'overview', 'modules', 'certificate'
      ...
      <div className="course-layout">
        ...
        <div className="title-progress-container">
          <div className="title-section">
            <h1 className="course-title">Computer Systems </h1>
             <h1 className="course-title">Servicing NC II</h1>
            ...
            {/* Course Stats - Moved here closer to description */}
            <div className="course-stats">
              ...
              <div className="stat-item">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#FFA726" stroke="none">
                  <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                </svg>
                <span>
                  {courseMetadata.totalRatings > 0 
                    ? `${courseMetadata.averageRating.toFixed(1)} rating (${courseMetadata.totalRatings})` 
                    : 'No ratings yet'}
                </span>
              </div>
            </div>
          ...
          {/* Progress Card (Compact) - Beside Title */}
            ...
            <div className="progress-card">
              ...
              <div className="rate-button-container">
                <button 
                  ...
                  disabled={hasRated}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill={hasRated ? "#FFA726" : "none"} stroke="currentColor" strokeWidth="2">
                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                  </svg>
            ...
            <div className="certificate-content-full">
              ...
              <div className="certificate-info-grid">
                <div className="certificate-section">
                  ...
                  <p>Upon successful completion of this course, you will receive an official TESDA National Certificate II in Computer Systems Servicing, recognized nationwide by employers and educational institutions.</p>
                </div>
