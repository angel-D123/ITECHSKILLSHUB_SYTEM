  ...
  return (
    <div className="course-page">
      ...
      <nav className="breadcrumb">
        ...
        <span className="breadcrumb-current">Operating System Installation & Configuration</span>
      </nav>
      ...
      <div className="course-layout">
        ...
        <div className="title-progress-container">
          <div className="title-section">
            <h1 className="course-title">Operating System Installation &</h1>
            <h1 className="course-title">Configuration</h1>
            <p className="course-description">
              Learn to install, configure, and optimize operating systems. This course covers Windows and Linux 
              installation, driver management, system tweaking, and troubleshooting common OS issues.
            </p>
