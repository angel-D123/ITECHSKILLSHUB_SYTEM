...
import '../../styles/PChardwareAT.css';
  ...
  return (
    <div className="course-page">
      ...
      <nav className="breadcrumb">
        ...
        <span className="breadcrumb-current">PC Hardware Assembly & Troubleshooting</span>
      </nav>
      ...
      <div className="course-layout">
        ...
        <div className="title-progress-container">
          <div className="title-section">
            <h1 className="course-title">PC Hardware Assembly &</h1>
            <h1 className="course-title">Troubleshooting</h1>
            <p className="course-description">
              Master the art of building, upgrading, and repairing computers. From identifying components to building 
              complete systems and troubleshooting hardware failures, you'll gain practical skills valued by IT employers.
            </p>
